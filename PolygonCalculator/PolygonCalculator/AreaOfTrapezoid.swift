...
class AreaOfTrapezoid: UIViewController, UITextFieldDelegate {
    
    @IBOutlet var base1Field : UITextField!
    @IBOutlet var base2Field : UITextField!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        base1Field.delegate = self
        base2Field.delegate = self
    ...
    @IBAction func calculate(_: AnyObject) {
        ...
        let base1 = base1Field.text!.floatValue
        let base2 = base2Field.text!.floatValue

...
class PerimeterOfQuads: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func calculate(_: AnyObject) {
        ...
        let side4 = side4Field.text!.floatValue
        
        let result = side1 + side2 + side3 + side4
